...
public class CarpRastgeleBalon : MonoBehaviour
{
    //animasyonlar
    ...
    public Text CaS1, CaS2, CaS3, CaS4, CaS5, CaS6, CaS7, CaS8, CaS9, CaS10;
    public void Start()
    {
    ...
    {
        CaS1.gameObject.SetActive(false);
        CaS2.gameObject.SetActive(false);
        CaS3.gameObject.SetActive(false);
        CaS4.gameObject.SetActive(false);
        CaS5.gameObject.SetActive(false);
        CaS6.gameObject.SetActive(false);
        CaS7.gameObject.SetActive(false);
        CaS8.gameObject.SetActive(false);
        CaS9.gameObject.SetActive(false);
        CaS10.gameObject.SetActive(false);
        ...
        if (sure >= 0 && sure < 45)
        {
            ...
            {
                case 1:
                    CaS1.gameObject.SetActive(true);
                    ...
                    break;
                case 2:
                    CaS2.gameObject.SetActive(true);
                    ...
                    break;
                case 3:
                    CaS3.gameObject.SetActive(true);
                    ...
                    break;
                case 4:
                    CaS4.gameObject.SetActive(true);
                    ...
                    break;
                case 5:
                    CaS5.gameObject.SetActive(true);
                    ...
                    break;
                case 6:
                    CaS6.gameObject.SetActive(true);
                    ...
                    break;
                case 7:
                    CaS7.gameObject.SetActive(true);
                    ...
                    break;
                case 8:
                    CaS8.gameObject.SetActive(true);
                    ...
                    break;
                case 9:
                    CaS9.gameObject.SetActive(true);
                    ...
                    break;
                case 10:
                    CaS10.gameObject.SetActive(true);

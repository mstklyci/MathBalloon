...
public class CıkarmaRastgeleBalon : MonoBehaviour
{
    //animasyonlar
    ...
    public Text CS1, CS2, CS3, CS4, CS5, CS6, CS7, CS8, CS9, CS10;
    public void Start()
    {
    ...
    {
        CS1.gameObject.SetActive(false);
        CS2.gameObject.SetActive(false);
        CS3.gameObject.SetActive(false);
        CS4.gameObject.SetActive(false);
        CS5.gameObject.SetActive(false);
        CS6.gameObject.SetActive(false);
        CS7.gameObject.SetActive(false);
        CS8.gameObject.SetActive(false);
        CS9.gameObject.SetActive(false);
        CS10.gameObject.SetActive(false);      
        ...
        if (sure >= 0 && sure < 45)
        {
            ...
            {
                case 1:
                    CS1.gameObject.SetActive(true);

                    B2.tag = "Dogru"; B5.tag = "Yanlis"; B1.tag = "Yanlis"; B4.tag = "Yanlis"; B3.tag = "Yanlis";
                ...
                case 8:
                    ...
                    break;
                case 9:
                    CS9.gameObject.SetActive(true);

                    B29.tag = "Dogru"; B33.tag = "Yanlis"; B30.tag = "Yanlis"; B31.tag = "Yanlis"; B32.tag = "Yanlis";
                    ...
                    break;
                case 10:
                    CS10.gameObject.SetActive(true);
